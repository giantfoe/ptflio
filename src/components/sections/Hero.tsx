...
export default function Hero() {
  return (
    <section id="home" className="min-h-[100svh] flex flex-col items-center justify-center relative overflow-hidden pb-8" style={{ backgroundImage: 'url(/tinywow_Background%2010_84379077.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      ...
      <SquaresBackground
        ...
        squares={[
          ...
          [20, 5], [25, 8], [18, 12], [22, 18],
          [30, 3], [35, 7], [28, 14], [32, 20]
        ]}
        className="absolute inset-0 z-5 opacity-30 [mask-image:radial-gradient(800px_circle_at_center,white,transparent)]"
      />
      ...
      <div className="absolute inset-0 z-15 bg-gradient-to-b from-black/20 via-black/10 to-black/30" />
      ...
      <Parallax speed={10} className="relative z-20">
      ...
      <Parallax speed={5} className="relative z-20">
